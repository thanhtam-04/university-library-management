...
INSERT INTO `authors` (`id`, `full_name`, `bio`, `nationality`, `created_at`, `pseudonym`, `image_url`) VALUES
	...
	(37, 'Lưu Thị Thanh Tâm', '', '', '2026-05-31 02:54:18', '', NULL);
...
INSERT INTO `book_copies` (`id`, `book_id`, `barcode`, `status`, `condition_note`, `acquired_date`) VALUES
	...
	(13, 3, 'BC-3-741851', 'BORROWED', NULL, '2026-05-28'),
...
-- Dumping data for table library_db.digital_documents: ~36 rows (approximately)
INSERT INTO `digital_documents` (`id`, `author`, `category`, `created_at`, `downloads`, `file_url`, `title`, `type`, `views`, `year`) VALUES
	...
	(3, 'Nguyễn Du', 'Văn học', '2026-05-31 15:32:50.024067', 0, '/uploads/documents/169b396e-d483-498f-990d-8c31afffd183_3_11_mau-quyen-bao-cao-thuc-tap-chuyen-nganh-1.pdf', 'Luận văn phân tích thi pháp văn học', 'luanvan', 0, 2022),
	...
	(24, 'E.H. Gombrich', 'Vật lý', '2026-05-31 15:22:19.437390', 0, '/uploads/documents/c3ccaa66-ea17-406a-98eb-46d966aeb2d5_3_11_Mau-quyển báo cáo Thực tập Chuyên ngành (1).pdf', 'Đề tài nghiên cứu ứng dụng vật liệu', 'nckh', 0, 2024),
	...
	(33, 'Nguyễn Đức Thiềm', 'Hóa học', '2026-05-31 15:24:11.073222', 0, '/uploads/documents/47e65d34-6996-4ce2-9f6f-c49bb89423bc_3_11_Mau-quyển báo cáo Thực tập Chuyên ngành (1).pdf', 'Giáo trình hóa học môi trường', 'giaotrinh', 0, 2024),
	...
	(36, 'ff', '', '2026-05-31 15:10:21.866192', 0, '', 'vff', 'giaotrinh', 0, NULL);
...
INSERT INTO `publishers` (`id`, `name`, `address`, `phone`, `email`, `website`, `created_at`) VALUES
	...
	(10, 'Thanh', '', '', '123456789@gmail.com', '', '2026-05-31 02:54:35');
...
-- Dumping data for table library_db.user_roles: ~8 rows (approximately)
...
INSERT INTO `users` (`id`, `username`, `password`, `full_name`, `email`, `phone`, `avatar`, `is_active`, `created_at`, `is_approved`) VALUES
	...
	(8, 'thuthu1', '$2a$10$PS9OxV4RwNaTFXGCxASJpetZt0yUjQJXKGCE8FM5R4v8SW8L9Eyv.', 'Nguyễn Quỳnh Hương', 'huong123@gmail.com', '0434874433', NULL, 1, '2026-05-31 02:33:30', b'1'),
	(9, 'Trungkien', '$2a$10$.bYAfE.7f.8og6VMTFjjNuvCFIQYhbgKwu9TaUk1.FFBBMHvxdPMm', 'Nguyễn Hữu Trung Kiên', 'Kien1234@gmail.com', '0345900337', NULL, 1, '2026-06-04 15:44:36', b'1');
